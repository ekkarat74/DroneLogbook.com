...
<head>
    <meta charset="utf-8" />
    <title>
        Pricing - DroneLogbook - Simplifying Drone Operations
    </title>
    <meta
        content="DroneLogbook has plans for all levels, providing monthly, quarterly &amp; annual billing, providing the best drone logbook feature set at the lowest price."
        name="description" />
    ...
    <script src="/_static/lib/skel.min.js">
    </script>
    <script src="/_static/lib/skel-panels.min.js">
    </script>
    <link href="/_static/lib/skel-noscript.css" rel="stylesheet" type="text/css">
    <link href="../../css/bootstrap.min.css" rel="stylesheet" />
    <link href="../../css/navigation.min.css" rel="stylesheet" />
    <link href="../../css/general-style.min.css?v=20210110" rel="stylesheet" />
...
<body>
        ...
        <div class="page-wrapper">
            <div class="content-container">
                <div class="column-left">
                    <h1>
                        Nous avons un plan pour chaque pilote
                    </h1>
                    <h2 class="sub-header long">
                        DroneLogbook a développé des plans adaptés à tous les niveaux d'exploitation commerciale de
                        drones, qu'il s'agisse d'une entreprise individuelle ou d'une opération multi-sites. De plus,
                        nous avons des plateformes conçues pour aider les fabricants de drones à mieux soutenir leurs
                        clients grâce à une solution de bout en bout visant à améliorer l'expérience client.
                    </h2>
                    <p style="color: #fff;">
                        <b>
                            2 mois d'essai gratuit pour tous les nouveaux utilisateurs
                        </b>
                    </p>
                </div>
            </div>
        ...
        <div class="page-wrapper" style="justify-content: center; flex-wrap: wrap; align-items: flex-start;">
            <div style="padding-left: 40px; padding-right: 10px; padding-top: 40px;">
                <p class="appstore__desc">
                    La solution DroneLogbook est basée sur une infrastructure cloud avec un stockage sécurisé des
                    données, une application web en ligne accompagnée de notre application mobile pour un accès hors
                    ligne et une synchronisation facile avec votre compte basé sur le cloud. De plus, l'application
                    mobile vous permet d'accéder aux dernières mises à jour de l'état de l'espace aérien, aux conditions
                    météorologiques locales et à l'indice solaire qui peuvent affecter vos opérations.
                </p>
                <br />
                <p class="appstore__desc">
                    Une autre application mobile Android, <b>DLBSync</b>, simplifie l'importation de vos vols à partir des principales applications de contrôle de vol de drone directement dans votre compte DroneLogbook. Cette application peut synchroniser les vols dans DLB Sync à partir de vos applications de contrôle de vol lorsque vous êtes hors ligne ou en cas de mauvaise couverture mobile, puis télécharger les vols vers votre compte DroneLogbook lorsque vous avez une couverture mobile ou WIFI.
                </p>
            </div>
    ...
    <script src="/_static/lib/jquery-3.6.1.min.js" type="text/javascript">
    </script>
    ...
    <link href="/_static/css/bootstrap-modal.css?v=20210108" rel="stylesheet" />
