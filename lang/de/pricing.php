        ...
        <div class="page-wrapper">
            <div class="content-container">
                <div class="column-left">
                    <h1>
                        Wir haben einen Plan für jeden Piloten
                    </h1>
                    <h2 class="sub-header long">
                        DroneLogbook hat Pläne entwickelt, die für alle Stufen des kommerziellen Drohnenbetriebs
                        geeignet sind, vom Einzelunternehmer bis hin zu Betrieben mit mehreren Standorten. Darüber
                        hinaus haben wir Plattformen entwickelt, die Drohnenherstellern dabei helfen, ihre Kunden mit
                        einer End-to-End-Lösung besser zu unterstützen und das Kundenerlebnis zu verbessern.
                    </h2>
                    <p style="color: #fff;">
                        <b>
                            2 Monate kostenlose Testphase für alle neuen Benutzer
                        </b>
                    </p>
                </div>
            </div>
        ...
        <div class="page-wrapper" style="justify-content: center; flex-wrap: wrap; align-items: flex-start;">
            <div style="padding-left: 40px; padding-right: 10px; padding-top: 40px;">
                <p class="appstore__desc">
                    Die DroneLogbook-Lösung basiert auf einer Cloud-Infrastruktur mit sicherer Datenspeicherung, einer
                    Online-Webanwendung und unserer mobilen Anwendung für den Offline-Zugriff und die einfache
                    Synchronisierung mit Ihrem cloudbasierten Konto. Darüber hinaus bietet Ihnen die mobile App Zugriff
                    auf die neuesten Informationen zum Luftraumstatus, lokale Wetterdaten und Sonnenindexwerte, die sich
                    auf Ihre Operationen auswirken können.
                </p>
                <br />
                <p class="appstore__desc">
                    Eine weitere Android-App, <b>DLBSync</b>, vereinfacht den Import Ihrer Flüge aus gängigen mobilen Drohnenflugsteuerungs-Apps direkt in Ihr DroneLogbook-Konto. Diese App kann Flüge von Ihren Flugsteuerungs-Apps synchronisieren, wenn Sie offline oder in Gebieten mit schlechter Mobilfunkabdeckung sind, und die Flüge dann hochladen, wenn Sie wieder Mobilfunk- oder WLAN-Abdeckung haben.
                </p>
            </div>
