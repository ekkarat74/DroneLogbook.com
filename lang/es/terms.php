        ...
        <div class="page-wrapper">
            <div class="content-container">
                <div class="column-left">
                    <h1>
                        Términos de Servicio de DroneLogbook
                    </h1>
                    <h2 class="sub-header long">
                        Tu privacidad es importante para nosotros. Los Términos de Servicio de DroneLogbook explican
                        cómo tratamos tus datos personales. Por favor, lee detenidamente los Términos de Servicio para
                        obtener información sobre la recopilación, uso y divulgación de tu información personal por
                        parte de DroneLogbook.
                    </h2>
                </div>
            </div>
        </div>
    ...
    <section class="faq">
        <div class="page-wrapper">
            <div class="content-wrapper">
                <div class="row">
                    <?php include_once ("../../../../profile/terms-include.php");?>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="appstore wedo" style="padding-top: 20px">
        <div class="page-wrapper" style="justify-content: center; flex-wrap: wrap; align-items: flex-start;">
            ...
            <div style="padding-left: 40px; padding-right: 10px; padding-top: 40px;">
                ...
                <br />
                <p class="appstore__desc">
                    Otra aplicación móvil para Android, <b>DLBSync</b>, simplifica la importación de tus vuelos desde las principales aplicaciones de control de vuelo de drones móviles directamente a tu cuenta de DroneLogbook. Esta aplicación puede sincronizar vuelos en DLB Sync desde tus aplicaciones de control de vuelo cuando estás sin conexión o con una mala cobertura móvil, luego cargar los vuelos en tu cuenta de DroneLogbook cuando tengas cobertura móvil o WIFI.
                </p>
            </div>
