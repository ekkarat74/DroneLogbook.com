        ...
        <div class="page-wrapper">
            <div class="content-container">
                <div class="column-left">
                    <h1>
                        Abbiamo un piano per ogni pilota
                    </h1>
                    <h2 class="sub-header long">
                        DroneLogbook ha sviluppato piani adatti a tutti i livelli di operazioni commerciali con droni,
                        dai singoli operatori a quelle a più sedi. Inoltre, abbiamo piattaforme progettate per aiutare i
                        produttori di droni a offrire un migliore supporto ai propri clienti attraverso una soluzione
                        end-to-end per migliorare l'esperienza del cliente.
                    </h2>
                    <p style="color: #fff;">
                        <b>
