...
<head>
  ...
  <link rel="canonical" href="https://www.dronelogbook.com/pricing.php">
  ...
  <meta name="twitter:text:description" content="DroneLogbook has plans for all levels, providing monthly, quarterly & annual billing, providing the best drone logbook feature set at the lowest price.">
  ...
  <script type="application/ld+json">
    {
      ...
      "description": "DroneLogbook has plans for all levels, providing monthly, quarterly & annual billing.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD",
        "description": "2 Months Free Trial For All New Users"
      },
      "publisher": {
        "@type": "Organization",
        "name": "DroneLogbook",
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <nav id="nav-links">
          ...
          <a href="security_merged.html" class="nav-link">Security</a>
    ...
    <div class="page-wrapper">
      <div class="content-container">
        <div class="column-left">
          ...
          <h2 class="sub-header long">DroneLogbook has developed plans to suit all levels of commercial drone operations from one person shop to multi-location
            operations. In addition, we have platforms designed to help drone manufacturers better support their customers
            via an end to end solution to enhance customer experience.</h2>
